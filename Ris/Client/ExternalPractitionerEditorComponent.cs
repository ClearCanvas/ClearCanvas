...
namespace ClearCanvas.Ris.Client
{
	...
	public class ExternalPractitionerEditorComponent : NavigatorComponentContainer
	{
		...
		public override void Start()
		{
			...
			this.Pages.Add(new NavigatorPage(new Path("NodeExternalPractitioner"), _detailsEditor = new ExternalPractitionerDetailsEditorComponent(_isNew)));
			this.Pages.Add(new NavigatorPage(new Path("NodeExternalPractitioner/NodeContactPoints"), _contactPointSummaryComponent));

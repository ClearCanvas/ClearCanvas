		...
		public override void Start()
		{
			Platform.GetService<IStaffAdminService>(
				delegate(IStaffAdminService service)
				{
					...
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff"), _detailsEditor));
					...
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff/NodePhoneNumbers"), _phoneNumbersSummary));
					...
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff/NodeAddresses"), _addressesSummary));
					...
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff/NodeEmailAddresses"), _emailAddressesSummary));



					// allow modification of non-elective groups only iff the user has StaffGroup admin permissions
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff/NodeGroups/NodeNonElective"), _nonElectiveGroupsEditor = new StaffNonElectiveStaffGroupEditorComponent(_staffDetail.Groups, formDataResponse.StaffGroupChoices, !CanModifyNonElectiveGroups)));
					this.Pages.Add(new NavigatorPage(new Path("NodeStaff/NodeGroups/NodeElective"), _electiveGroupsEditor = new StaffElectiveStaffGroupEditorComponent(_staffDetail.Groups, formDataResponse.StaffGroupChoices, !CanModifyStaffProfile)));
				});

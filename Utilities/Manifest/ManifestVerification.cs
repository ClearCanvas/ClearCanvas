	...
	public sealed class ManifestVerification
	{
		...
		internal static string ErrorMessage
		{
			get
			{
				lock (SyncLock)
				{
					return _verificationRun ? _verificationError : string.Empty;
				}
			}
		}
		...
		private static string _verificationError;
		...
		private bool Verify(out string reason)
		{
			try
			{
				...
				LoadManifestFiles(out delayedException);
				...
				{
					reason = delayedException.Message;
					return false;
				}

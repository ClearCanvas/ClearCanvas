...
{
	[PrincipalPermission(SecurityAction.Demand, Role = AuthorityTokens.Admin.Configuration.DataAccessRules)]
	public partial class Default : BasePage
	{
		...
		{
			var copiedRule = new ServerRule(rule.RuleName + " (Copy)", rule.ServerPartitionKey, rule.ServerRuleTypeEnum,
			                                rule.ServerRuleApplyTimeEnum, rule.Enabled, rule.DefaultRule, rule.ExemptRule,
			                                (XmlDocument) rule.RuleXml.CloneNode(true));

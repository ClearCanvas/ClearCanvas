					...
					<asp:Panel ID="Panel6" runat="server" CssClass="SearchPanelContent" DefaultButton="SearchButton">
						<div class="SearchPanelParentDiv">
							<div class="SearchPanelChildDiv">
								...
								<ccUI:TextBox ID="AETitleFilter" runat="server" CssClass="SearchTextBox" ToolTip="Search the list by AE Title"/>
							</div>
							<div class="SearchPanelChildDiv">
								<asp:Label ID="Label6" runat="server" Text="<%$Resources: SearchFieldLabels, DeviceDescription %>"
								           CssClass="SearchTextBoxLabel" EnableViewState="False"/><br />
								<ccUI:TextBox ID="DescriptionFilter" runat="server" CssClass="SearchTextBox" ToolTip="Search the list by Description"/>
							</div>
							<div class="SearchPanelChildDiv">
								<asp:Label ID="Label2" runat="server" Text="<%$Resources: SearchFieldLabels, IPAddress %>"
									CssClass="SearchTextBoxLabel" EnableViewState="False"></asp:Label><br />
								<ccUI:TextBox ID="IPAddressFilter" runat="server" CssClass="SearchTextBox" ToolTip="Search the list by IP Address"/>
							</div>
							<div class="SearchPanelChildDiv">
								<asp:Label ID="Label3" runat="server" Text="<%$Resources: SearchFieldLabels, DeviceStatus %>"
								           CssClass="SearchTextBoxLabel"/><br />
								<asp:DropDownList ID="StatusFilter" runat="server" CssClass="SearchDropDownList"/>
							</div>
							<div class="SearchPanelChildDiv">
								<asp:Label ID="Label4" runat="server" Text="<%$Resources: SearchFieldLabels, DHCP %>"
								           CssClass="SearchTextBoxLabel"/><br />
								<asp:DropDownList ID="DHCPFilter" runat="server" CssClass="SearchDropDownList"/>
							</div>
							<div class="SearchPanelChildDiv">
								<asp:Label ID="Label5" runat="server" Text="<%$Resources: SearchFieldLabels, DeviceType %>"
								           CssClass="SearchTextBoxLabel"/><br />
								...
								<asp:UpdatePanel ID="ToolBarUpdatePanel" runat="server" UpdateMode="Conditional">
									<ContentTemplate>
										<asp:Panel ID="ToolbarButtons" runat="server" CssClass="ToolbarButtons">
											<ccUI:ToolbarButton ID="AddDeviceButton" runat="server" SkinID="<%$Image:AddButton%>"
												OnClick="AddDeviceButton_Click" />
											<ccUI:ToolbarButton ID="EditDeviceButton" runat="server" SkinID="<%$Image:EditButton%>"
												OnClick="EditDeviceButton_Click" />

...
namespace ClearCanvas.ImageServer.Common
{
	...
	/// </summary>
	public class StreamingHttpConfiguration : IServiceHostConfiguration
	{
		...
		public void ConfigureServiceHost(ServiceHost host, ServiceHostConfigurationArgs args)
		{
			...
			binding.Security.Mode = WebServicesSettings.Default.BasicSecurityMode;
	...
	/// </summary>
	public class ClientStreamingHttpConfiguration : IServiceChannelConfiguration
	{
		...
		public ChannelFactory ConfigureChannelFactory(ServiceChannelConfigurationArgs args)
		{
			...
			binding.Security.Mode = WebServicesSettings.Default.BasicSecurityMode;
			if (args.AuthenticationRequired)

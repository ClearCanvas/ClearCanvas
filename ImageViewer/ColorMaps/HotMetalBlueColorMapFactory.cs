...
namespace ClearCanvas.ImageViewer.ColorMaps
{
	...
	public class HotMetalBlueColorMapFactory : IColorMapFactory
	{
		public static readonly string ColorMapName = "HOT_METAL_BLUE";
		private const string _colorMapDescription = "Hot Metal Blue";
		...
		{
			return new DicomPaletteColorMap(_colorMapDescription, PaletteColorLut.HotMetalBlue);
		}

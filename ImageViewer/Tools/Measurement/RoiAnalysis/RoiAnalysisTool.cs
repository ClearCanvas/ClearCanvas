	...
	public class RoiAnalysisTool : ImageViewerTool
	{
		...
		public void Show()
		{
			...
			if (_roiAnalysisComponent == null)
			{
				...
				_roiAnalysisComponent = new RoiAnalysisComponentContainer(DesktopWindow);
                _roiAnalysisComponent.Stopped += _roiAnalysisComponent_Stopped;
        ...
        private void _roiAnalysisComponent_Stopped(object sender, System.EventArgs e)
        {

...
namespace ClearCanvas.ImageViewer.View.WinForms
{
	...
	public partial class ImageBoxControl : UserControl
	{
		...
		private void AttachExtension(IImageBoxExtension extension)
		{
		...
		private IImageBoxExtensionView FindExtensionView(IImageBoxExtension extension)
		{
			IImageBoxExtensionView view;
			if (_extensionViews.TryGetValue(extension, out view))
			{
		...
		private void DisposeExtension(IImageBoxExtension extension)
		{
			extension.PropertyChanged -= OnExtensionPropertyChanged;
		...
		private void OnExtensionKeyUp(object sender, KeyEventArgs e)
		{
		...
		private void OnExtensionKeyDown(object sender, KeyEventArgs e)
		{
			// let tile controls handle it first
			foreach (var tileControl in TileControls)
			{
		...
		private void OnExtensionMouseDown(object sender, MouseEventArgs e)
		{
			_imageBox.SelectDefaultTile();
		}

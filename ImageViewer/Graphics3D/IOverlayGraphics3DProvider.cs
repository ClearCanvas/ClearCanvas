...
{
	/// <summary>
	/// Provides access to a <see cref="GraphicCollection3D"/> containing user-level graphics.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a <see cref="GraphicCollection3D"/> to <see cref="ImageViewerTool"/> objects, 
	...
	/// </para>
	/// </remarks>
	public interface IOverlayGraphics3DProvider
	{
		/// <summary>
		/// Gets a <see cref="GraphicCollection3D"/> of user-level graphics.
		/// </summary>
		GraphicCollection3D OverlayGraphics3D { get; }
	}
}
...
namespace ClearCanvas.Dicom.Iod.Modules
{
	...
	public class EnhancedPetSeriesModuleIod : IodBase
	{
		...
		public EnhancedPetSeriesModuleIod(IDicomAttributeProvider dicomAttributeProvider)
		...
		public RelatedSeriesSequence[] RelatedSeriesSequence
		{
			get
			{
				var dicomAttribute = DicomAttributeProvider[DicomTags.RelatedSeriesSequence];
				if (dicomAttribute.IsNull || dicomAttribute.IsEmpty)
				{
					return null;
				}
			...
			set
			{
				...
				{
					DicomAttributeProvider[DicomTags.RelatedSeriesSequence] = null;
					return;
				}
				...
				DicomAttributeProvider[DicomTags.RelatedSeriesSequence].Values = result;
			}
		}

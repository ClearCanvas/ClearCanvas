...
{
	/// <summary>
	/// Opthalmic Tomography Series Module
	/// </summary>
	/// <remarks>As defined in the DICOM Standard 2011, Part 3, Section C.8.17.6 (Table C.8.17.6-1)</remarks>
	public class OpthalmicTomographySeriesModuleIod : IodBase
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="OpthalmicTomographySeriesModuleIod"/> class.
		/// </summary>	
		public OpthalmicTomographySeriesModuleIod() {}

		/// <summary>
		/// Initializes a new instance of the <see cref="OpthalmicTomographySeriesModuleIod"/> class.
		/// </summary>
		/// <param name="dicomAttributeProvider">The DICOM attribute collection.</param>
		public OpthalmicTomographySeriesModuleIod(IDicomAttributeProvider dicomAttributeProvider)

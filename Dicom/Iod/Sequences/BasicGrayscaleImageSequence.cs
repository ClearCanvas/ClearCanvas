...
namespace ClearCanvas.Dicom.Iod.Sequences
{
    ...
    public class BasicGrayscaleImageSequence : SequenceIodBase
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="BasicGrayscaleImageSequence"/> class.
        /// </summary>
        public BasicGrayscaleImageSequence()
            : base()
        {
        }
        ...
        public BasicGrayscaleImageSequence(DicomSequenceItem dicomSequenceItem)
